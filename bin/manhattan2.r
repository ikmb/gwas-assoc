...
jpeg(file=paste(file.results, ".manhattan2.jpg", sep=""), quality=100,width=1600,height=700)
plot(pos.plot,-log10(gwas$P),col=colplot,ylab="-log10(p)", xlab="Chromosome",ylim=c(0,100),xaxt="n",pch=20,las=1,cex=1.5, main=paste( disease_name, sep=" "))
# ,ylim=c(0,7)

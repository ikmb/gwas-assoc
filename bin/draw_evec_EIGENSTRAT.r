...
#eigenvect <- read.table(file=paste(file.prefix, ".pca.evec", sep=""), skip=1, col.names=c("indivID", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10", 
...
pairs(eigenvect[,2:5], col=eigenvect$batch, labels=thelabels, pch=19)
dev.off()

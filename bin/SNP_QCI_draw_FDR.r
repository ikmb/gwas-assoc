...
text(fdr[FDR_index_remove_variants], fdr.hwe.allbatches$Fail_worstbatchremoved[FDR_index_remove_variants]/1000, labels=c(fdr.hwe.allbatches$Fail_worstbatchremoved[FDR_index_remove_variants]/1000), pos=4)
